...
import com.ipooglecodes.testandrodapp.FragmentSettings
import com.ipooglecodes.testandrodapp.Fragments.FragmentEditSnaps
import com.ipooglecodes.testandrodapp.R
import com.ipooglecodes.testandrodapp.TextAdapter
...
class MainActivity : AppCompatActivity(), TextAdapter.OnItemClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rel_snaps.setOnClickListener {
            ...
            txt_text.setTextColor(resources.getColor(R.color.blue))
        ...
        rel_settings.setOnClickListener {
            ...
            txt_settings.setTextColor(resources.getColor(R.color.blue))
